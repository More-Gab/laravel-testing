...
<body>
    ...
    <section class="list">
        <div>
            ...
            <ul>
                <li><a href="/ocean/arctic">Arctic Ocean</a></li>
                <li><a href="/ocean/atlantic">Atlantic Ocean</a></li>
                <li><a href="/ocean/indian">Indian Ocean</a></li>
                <li><a href="/ocean/pacific">Pacific Ocean</a></li>
                <li><a href="/ocean/southern">Southern Ocean</a></li>
            </ul>
        </div>
    </section>
